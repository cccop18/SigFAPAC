...
@RestController
@RequestMapping(value = "/pesquisadorEs", produces = MediaType.APPLICATION_JSON_VALUE)
@Tag(
    name = "Pesquisador",
    description = "Endpoints para gerenciar os pesquisadores"
)
public class PesquisadorEstrangeiroController implements IController<PesquisadorEstrangeiroDto>{
    ...
    public PesquisadorEstrangeiroController(
            PesquisadorService servico, 
            PesquisadorEstrangeiroMapper mapper, 
    ...
    public ResponseEntity<Page<PesquisadorEstrangeiroDto>> get(
        ...
        Page<PesquisadorEstrangeiroDto> dtos = registros.map(mapper::toDto); 
    ...
    @GetMapping("/{id}")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Pesquisador estrangeiro encontrado"),
        @ApiResponse(
            responseCode = "404",
            description = "Pesquisador estrangeiro não encontrado",
            content = @Content(
    ...
    public ResponseEntity<PesquisadorEstrangeiroDto> get(@PathVariable("id") Long id) {
    ...
    public ResponseEntity<PesquisadorEstrangeiroDto> insert(@RequestPart @Valid PesquisadorEstrangeiroDto objeto, 
        ...
        PesquisadorEstrangeiroDto dto = mapper.toDto(pesquisadorSalvo);
        return ResponseEntity.status(HttpStatus.CREATED).body(dto);
    }

    @Transactional
    private Pesquisador inserirPesquisadorEstrangeiro(PesquisadorEstrangeiroDto objeto, MultipartFile fotoPesquisador) {
        ...
        pesquisador.setPassaportePesquisador(objeto.passaportePesquisador());
    ...
    @PutMapping("/")
    @Operation(
        summary = "Atualizar um pesquisador estrangeiro existente",
        description = "Atualiza as informações de um pesquisador estrangeiro existente"
    )
    public ResponseEntity<PesquisadorEstrangeiroDto> update(@RequestBody @Valid PesquisadorEstrangeiroDto objeto) {
    ...
    @DeleteMapping("/{id}")
    @Operation(
        summary = "Deletar um pesquisador estrangeiro",
        description = "Deleta o pesquisador estrangeiro com o ID informado"
    )
    ...
    @Override
    public ResponseEntity<?> insert(PesquisadorEstrangeiroDto objeto) {
